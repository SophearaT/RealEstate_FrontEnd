<template>
    <div class="flex  bg-gray-100">
        ...
        <!-- Sidebar -->
        <aside class="w-64 min-h-screen bg-gray-300 bg-cover shadow-xl flex flex-col">
            <!--Company Logo-->
            <router-link to="/">
            <div class="flex  items-center gap-2">
                <div class="w-[47px] h-[47px] flex items-center justify-center text-gray-800">
                    <svg width="30" height="24" viewBox="0 0 31 25" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M0.449219 24.5843L8.53524 8.41225L14.5998 20.5413H24.7073L17.9689 7.09828L14.5998 13.7692L12.9152 10.4338L17.9689 0.326233L30.098 24.5843H0.449219ZM5.8399 20.5413H11.2306L8.53524 15.1338L5.8399 20.5413Z" />
                    </svg>
                </div>

                <h1 class="text-2xl font-bold text-gray-800 tracking-[-0.48px]">La Mansion</h1>
            </div>
            </router-link>
            <nav class=" flex-1 p-4 space-y-3">
                <router-link to="/userdashboard" class="text-xl flex items-center block py-2 px-4 rounded-md hover:bg-blue-100 text-gray-800 font-medium">
                    <span class="material-icons text-sm text-gray-600">dashboard</span>
                    Dashboard
                </router-link>
                <router-link to="/userdashboard/userprofile"
                    class="text-xl flex items-center block py-2 px-4 rounded-md hover:bg-blue-100 text-gray-800 font-medium">
                    <span class="material-icons text-sm text-gray-600">person</span>
                    Profile
                </router-link>
                <router-link to="/userdashboard/properties"
                    class="text-xl flex items-center block py-2 px-4 rounded-md hover:bg-blue-100 text-gray-800 font-medium">
                    <span class="material-icons text-sm text-gray-600">home</span>
                    Property
                </router-link>
                <div class="mt-100">
                <router-link to="/setting"
                    class="text-xl flex items-center block py-2 px-4 rounded-md hover:bg-blue-100 text-gray-800 font-medium">
                    <span class="material-icons text-sm text-gray-600">settings</span>
                    Setting
                </router-link> 
                <router-link to="/login"
                    class="text-xl flex items-center block py-2 px-4 rounded-md hover:bg-blue-100 text-gray-800 font-medium">
                    <span class="material-icons text-sm text-gray-600">logout</span>
                    Log Out
                </router-link>
                </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <!-- Top Navbar -->
            <header class="flex items-center justify-between px-6 py-4 bg-black shadow-sm">
                <!-- Logo -->
                <div class="text-xl font-bold text-blue-300">Your Information</div>

                <!-- Search Bar -->
                <div class="flex-1 max-w-lg mx-6 relative">
                    <img src="/src/assets/Photos/search.svg" alt="Search Icon" class="w-7 h-7 absolute left-3 top-1/2 transform -translate-y-1/2"/>
                    
                    <input type="text" placeholder="Search here..."
                        class="w-full text-gray-100 pl-15 pr-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400" />
                ...
                <div class="flex items-center gap-4">
                    <div>
                        <img src="/src/assets/Photos/mypic.jpg" alt="User"
                            class="w-10 h-10 rounded-full border-2 border-blue-500" />
                    </div>
                    <div class="flex-col">
                        <h1 class="text-gray-100 font-bold text-md">Yoy Koemyorn</h1>
                        <h1 class="text-blue-200 text-sm font-bold">Sailor</h1>
                    </div>
                </div>
            </header>
